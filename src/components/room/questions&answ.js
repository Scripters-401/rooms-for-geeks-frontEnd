                ...
                return (
                    <div className='questionDiv' key={idx}>
                        <div className="quesHeader">
                            ...
                            <hr className="magic" />
                            <span className="answerLength" onClick={e => why(idx)}>{element.answers.length}  Answers</span>
                        </div>


                        <div className="numberOfAnswer">
                            <div className="questionAsked" onClick={e => goToQuestion(idx)}>

                                Q{idx + 1}: <span className="sapnAQ">{element.question}</span>
                            </div>
                            <p className="checAns">
                                <ul className={props.room.answersHide === idx ? 'answers-true' : 'answers-false'} >
...
const mapDispatchToProps = (dispatch, getState) => ({
    ...
    updateAnswersHide: (id) => dispatch(actions.updateAnswersHide(id)),
});
